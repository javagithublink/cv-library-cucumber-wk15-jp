...
//************************** Waits Methods *********************************************//
    ...
    public void pmVerifyElements(String displayMessage,String expectedMessage, By by) {
    ...
    /*public void verificationMethodUsingWait(String expectedMessage, By theActualMessage, int timeForWait) {
        ...
        pmVerifyElements("Message is displayed incorrectly",expected, actual);
    }*/
    ...
    public void verifyTheSortingOrderOfPriceLowToHighIsCorrect(By beforeFilterElements, By dropDown, By lowToHigh) {
        ...
        Assert.assertEquals("List is not sorted according to price Low to High",beforeFilterDoublePriceList, afterFilterDoublePriceList);
    }
    ...
    public void verifyIfProductsAreSortedByPriceHighToLow(By beforeFilterElements, By dropDown, By hToLow) throws InterruptedException {
        ...
        Assert.assertEquals("products are not sorted",originalProductPriceList, afterSortingProductPrice);
